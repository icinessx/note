...
_EOF_
    ...
    #下载ocserv并编译安装
    wget -t 0 -T 60 "https://raw.githubusercontent.com/fanyueciyuan/ocserv-backup/master/ocserv-0.10.8.tar.xz"
...
_EOF_
    ...
    sed -i "s/dns = 192.168.1.2/dns = 100.100.2.138\ndns = 100.100.2.136/g" "${confdir}/ocserv.conf"
